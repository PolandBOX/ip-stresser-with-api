...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
      ...
      <meta property="og:title" content="Tytul GO">
      ...
      <link rel="apple-touch-icon" href="/welcome/images/template/apple-touch-icon.png">
      <link rel="apple-touch-icon" sizes="72x72" href="/welcome/images/template/icon-72x72.png">
      <link rel="apple-touch-icon" sizes="114x114" href="/welcome/images/template/icon-114x114.png">
   </head>
   <body>
      ...
      <nav class="navbar navbar-default navbar-fixed affix-top" data-spy="affix" data-offset-top="120">
         <div class="container">
            <div class="navbar-header">
               ...
               <img src="files/main.png" alt="Logo">
               </a>
            </div>
            <div class="collapse navbar-collapse" id="nav-collapse">
               <ul class="nav navbar-nav navbar-right" id="one-page-nav">
                  ...
                  <li class=""><a href="https://discord.gg/ntqsJdE"> Discord</a></li>
                     ...
                     <div class="left-part wow animated fadeInUp" data-wow-delay="0.5s" data-wow-duration="1.5s">
                        <div class="banner-content col-lg-12">
                           ...
                           <div class="button-group">
                              <a class="btn play-store" href="http://localhost/vstress/panel/login.php"> Login</a>
                              <a class="btn app-store" href="http://localhost/vstress/panel/register.php"> Register</a>
                           </div>
                        </div>
                     </div>
                  </center>
               ...
               <div class="price-items" style="font-family: &#39;Permanent Marker&#39;, cursive;
                  ...
                  <div class="col-md-4">
                     <div class="price-item wow animated fadeInUp" data-wow-duration="1.5s">
                        ...
                        <a href="#" class="btn pack-btn">Purchase Now</a>
                     </div>
                  </div>
                  <div class="col-md-4">
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <div class="footer-widget">
                           <a class="c wow animated fadeInDown" data-wow-duration="1.5s" href="index.php">
                           <img src="files/main.png" alt="Footer logo">
                           </a>
                           <p class="copyright wow animated fadeInUp" data-wow-delay="1s" data-wow-duration="1.5s">all rights reserved to <a href="javascript:void(0)">Boxi</a> © 2020</p>
                        </div>
                     </div>
                  </div>
               </div>
